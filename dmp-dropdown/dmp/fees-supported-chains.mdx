...
liable](dmp-dropdown/dmp/slashing-and-delegated-staking) for the proper operation of the protocol as liquid assets staked for them will act as protocol financial
guarantees.
...
[`DebridgeGate` smart contract](dmp-dropdown/dev-guides/evm/building-evm-dapp).
