...
![Cross-Chain Message Diagram](/images/dmp-dropdown/evm-dapp-1.png)
...
![Dapp Diagram](/images/dmp-dropdown/evm-dapp-2.png)
...
A complete list of flags with their description can be found on [EVM smart contract interfaces page](dmp-dropdown/dev-guides/evm/libraries/flags).
...
Consider reading the [Lifecycle of a cross-chain](dmp-dropdown/dev-guides/cross-chain-call-lifecycle) call to get yourself familiar with how the cross-chain calls
are handled.
...
- [Gathering data for the claim](dmp-dropdown/dev-guides/gathering-data-for-claim)
