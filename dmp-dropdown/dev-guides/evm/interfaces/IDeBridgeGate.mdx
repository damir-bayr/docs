...
Used for transfers [into the native chain](https://docs.debridge.finance/the-core-protocol/transfers#transfer-from-secondary-chain-to-native-chain) to
unlock the designated amount of asset from collateral and transfer it to the receiver.
