...
![Cross-chain Call Lifecycle](/images/dmp-dropdown/cross-chain-call-lifecycle.png)
...
Note: Validators' financial responsibility to be enabled through [Slashing and Delegated Staking](dmp-dropdown/dmp/slashing-and-delegated-staking).
...
![Claim Details](/images/dmp-dropdown/claim-details.png)
