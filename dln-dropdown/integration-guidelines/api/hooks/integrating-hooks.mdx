...
hook](/protocol-specs/evm-chains-hook-anatomy#universal-hook), the DLN API provides a simple shortcut for that:
...
[HookDataV1](/protocol-specs/evm-chains-hook-anatomy) struct:
