...
Parameters](dln-dropdown/integration-guidelines/api/creating-order/api-parameters/api-parameters) and [API
Response](dln-dropdown/integration-guidelines/api/creating-order/api-parameters/response) sub-pages, while Swagger specs for `create-tx` can be explored
...
[Quick Start](dln-dropdown/integration-guidelines/api/creating-order/quick-start) section of the docs.
...
strategy](dln-dropdown/integration-guidelines/api/creating-order/quoting-strategies) (both amounts fixed). Limit orders can drive solver profit negative, so they
