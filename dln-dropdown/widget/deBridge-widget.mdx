...
![Widget Image](/images/dln-dropdown/widget.avif)
...
```
![Widget Styles](/images/dln-dropdown/widget-styles.png)
...
- Example usage:
    ...
    widget.setExternalEVMWallet({
      ...
      name: "Metamask",
      imageSrc: 'https://app.debridge.finance/assets/images/dln-dropdown/wallet/metamask.svg'
    });
    ```
...
- Example usage:
    ...
    widget.setExternalSolanaWallet({
      ...
      name: "Phantom",
      imageSrc: 'https://app.debridge.finance/assets/images/dln-dropdown/wallet/phenom.svg'
    });
    ```
