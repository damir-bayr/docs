...
![Order execution flow diagram](/images/dln-dropdown/order-execution-flow.avif)
...
![Source Chain Order Creation](/images/dln-dropdown/source-chain-order-creation.avif)
...
![Destination Chain Order Fulfillment Diagram](/images/dln-dropdown/destination-chain-order-fulfillment.avif)
...
![Unlocking Fulfilled Orders Diagram](/images/dln-dropdown/unlocking-orders.avif)
...
![Risk distribution diagram](/images/dln-dropdown/risk-distribution.avif)