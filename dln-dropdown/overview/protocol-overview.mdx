...
![Order execution flow diagram](/images/dln/order-execution-flow.avif)
...
![Source Chain Order Creation](/images/dln/source-chain-order-creation.avif)
...
![Destination Chain Order Fulfillment Diagram](/images/dln/destination-chain-order-fulfillment.avif)
...
![Unlocking Fulfilled Orders Diagram](/images/dln/unlocking-orders.avif)
...
![Risk distribution diagram](/images/dln/risk-distribution.avif)