...
Affiliate fees can be specified by any integration using the [DLN API](/integration-guidelines/api/authentication) or the [deBridge
...
solver](/dln-specifics/order-fulfillment/claiming-order) from a fulfilled order—typically within a few hours after the order execution.
