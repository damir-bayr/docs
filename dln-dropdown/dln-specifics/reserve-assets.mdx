...
[DeBridge Liquidity Network (DLN)](dln-dropdown/overview/introduction) operates as a free and competitive market where solvers fulfill cross-chain 
...
initially bridged by the user on the source chain. These combined expenses constitute the [operating expenses](dln-dropdown/overview/fee-structure) for solvers.
...
bridged tokens. Further details about operating costs and fees are available [here](dln-dropdown/overview/fees-supported-chains).